...
function Hero() {
  return (
    <div className="flex flex-col items-center justify-between mx-8 md:mx-28 lg:mx-56 xl:mx-80 gap-16">
      <h1 className="font-extrabold text-4xl md:text-5xl text-center leading-12 md:leading-16 mt-10 sm:mt-16">
